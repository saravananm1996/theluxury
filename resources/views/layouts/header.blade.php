            ...
            <div class="header-top bg-dark text-white">
                <div class="container justify-content-center">
                    <div class="header-left">
                        <h5 class="top-notice mb-0 pl-0">Get 10% OFF at the Porto Fashion Selection - <a
                                href="demo11-shop.html">Shop Now!</a></h5>
                    </div><!-- End .header-left-->
                    ...
                    <div class="header-right d-none d-sm-flex">
                        <nav class="main-nav w-100 d-xl-block d-none">
                            <ul class="menu sf-arrows d-flex align-items-center no-superfish">
                                ...
                                <li>
                                    <a href="demo11-shop.html" class="sf-with-ul">Categories</a>
                                ...
                                <li>
                                    <a href="demo11-product.html" class="sf-with-ul">Products</a>
								...
								<li class=" no-subMenu"><a href="{{ route('about-us') }}">About Us</a></li>
                        		<li class=" no-subMenu"><a href="{{ route('contact-us') }}">Contact Us</a></li>                                
                            </ul>
                        </nav>
                ...
                <div class="header-middle sticky-header">
                    <div class="container">
                                    ...
                                    <ul class="popup-menu-ul">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="demo11-about.html">About Us</a></li>
                                                <li><a href="#">Blog</a>
                                                    <ul>
                                                ...
                                                <li><a href="demo11-contact.html">Contact Us</a></li>
                        ...
                        <div class="header-right">
                            <div
                                class="header-icon header-search header-search-inline header-search-category d-none d-sm-block border-left-0 mb-0">
                                <a href="#" class="search-toggle" role="button"><i class="icon-magnifier"></i></a>
                                <form action="{{ route('live.search') }}" method="GET" autocomplete="off">
                                    <div class="header-search-wrapper">                                        
                                        <input type="search" class="form-control bg-transparent" name="search" id="search-input" placeholder="Search..." autocomplete="off" value="{{ request()->query('search') }}" required>
                                        <button class="btn icon-magnifier bg-transparent border-left-0"
                                            type="submit"></button>
